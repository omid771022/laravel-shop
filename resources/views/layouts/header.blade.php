            ...
            <ul class="nav">
                <ul class="nav">
                    @foreach($categories as $category)
                        ...
                        <li class="main-menu {{ count($category->subCategory) ? 'has-sub' : '' }}"><a href="{{ $category->path() }}">{{ $category->name }}</a>
                            @if(count($category->subCategory))
                                <div class="sub-menu">
                                    <div class="container">
                                        @foreach($category->subCategory as $subCategoise)
                                        <div><a href="{{ $subCategoise->path() }}">{{ $subCategoise->name }}</a></div>
                                        @endforeach
                                    </div>
                                </div>
