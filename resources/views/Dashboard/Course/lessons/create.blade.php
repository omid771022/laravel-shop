...
@section('contentDashboard')
    ...
    <div class="row no-gutters  ">
        <div class="col-12 bg-white">
            ...
            <form action="{{ route('lesson.store', $id) }}"  class="padding-30" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <input type="text" name="slug" placeholder="نام انگلیسی درس اختیاری" class="text-left text text mlg-15" required />
@if (count($seasons))
                ...
                <div class="file-upload">
                    <div class="i-file-upload">
                        <span>آپلود  درس</span>
                        <input type="file" class="file-upload" id="lesson_file" name="lesson_file" {{old('lesson_file')}} />
                    </div>
