                    ...
                    <div class="tutor-item">
                        <div class="tutor-avatar">
                            ...
                            <span class="tutor-image" id="tutor-image">
                                <img src="/uploads/upload/{{$tutor->image}}" class="tutor-avatar-img"></span>
                            <div class="tutor-author-name">
                                <a id="tutor-author-name" href="{{ $tutor->name }}" title="">
                            ...
                            <div id="Modal1" class="modal">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <img class="tutor--avatar--img" src="/uploads/upload/{{$tutor->image}}" alt="">
                                    </div>
            ...
            <div class="box-filter">
                ...
                <div class="posts">
                    @foreach($tutor->courses as $courseItem)
                        @include('layouts.singlecourseBox')
                    @endforeach
                </div>
            </div>
        </div>
